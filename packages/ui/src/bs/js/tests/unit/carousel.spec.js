  ...
  describe('data-api', () => {
    ...
    it('should create carousel and go to the next slide on click', done => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <div class="carousel-control-prev" data-bs-target="#myCarousel" role="xBtn" data-bs-slide="prev"></div>',
        '  <div id="next" class="carousel-control-next" data-bs-target="#myCarousel" role="xBtn" data-bs-slide="next"></div>',
        '</div>'
      ].join('')
    ...
    it('should do nothing if no selector on click on arrows', () => {
      fixtureEl.innerHTML = [
        ...
        '  </div>',
        '  <div class="carousel-control-prev" data-bs-target="#myCarousel" role="xBtn" data-bs-slide="prev"></div>',
        '  <div id="next" class="carousel-control-next" role="xBtn" data-bs-slide="next"></div>',
        '</div>'
      ].join('')
