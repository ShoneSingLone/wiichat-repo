...
describe('Collapse', () => {
  ...
  describe('data-api', () => {
    it('should show multiple collapsed elements', done => {
      fixtureEl.innerHTML = [
        '<a role="xBtn" data-bs-toggle="collapse" class="collapsed" href=".multi"></a>',
    ...
    it('should hide multiple collapsed elements', done => {
      fixtureEl.innerHTML = [
        '<a role="xBtn" data-bs-toggle="collapse" href=".multi"></a>',
    ...
    it('should remove "collapsed" class from target when collapse is shown', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" role="xBtn" data-bs-toggle="collapse" class="collapsed" href="#" data-bs-target="#test1"></a>',
        '<a id="link2" role="xBtn" data-bs-toggle="collapse" class="collapsed" href="#" data-bs-target="#test1"></a>',
        '<div id="test1"></div>'
      ].join('')
    ...
    it('should add "collapsed" class to target when collapse is hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" role="xBtn" data-bs-toggle="collapse" href="#" data-bs-target="#test1"></a>',
        '<a id="link2" role="xBtn" data-bs-toggle="collapse" href="#" data-bs-target="#test1"></a>',
    ...
    it('should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="trigger1" role="xBtn" data-bs-toggle="collapse" href="#test1"></a>',
        '<a id="trigger2" role="xBtn" data-bs-toggle="collapse" href="#test2"></a>',
        '<a id="trigger3" role="xBtn" data-bs-toggle="collapse" href=".multi"></a>',
