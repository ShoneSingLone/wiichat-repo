...
describe('Dropdown', () => {
  ...
  describe('constructor', () => {
    ...
    it('should allow to pass config to Popper with `popperConfig`', () => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <xBtn class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
  ...
  describe('toggle', () => {
    it('should toggle a dropdown', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <xBtn class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should destroy old popper references on toggle', done => {
      fixtureEl.innerHTML = [
        ...
        '  <xBtn class="firstBtn btn" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>',
        '<div class="second dropdown">',
        '  <xBtn class="secondBtn btn" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should not toggle a dropdown if the element is disabled', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <xBtn disabled class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should not toggle a dropdown if the element contains .disabled', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <xBtn class="btn dropdown-toggle disabled" data-bs-toggle="dropdown">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
  ...
  describe('data-api', () => {
    ...
    it('should not use Popper if display set to static', done => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <xBtn class="btn dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
    ...
    it('should remove "show" class if body is clicked, with multiple dropdowns', done => {
      fixtureEl.innerHTML = [
        ...
        '</div>',
        '<div class="btn-group">',
        '  <xBtn class="btn">Actions</xBtn>',
        '  <xBtn class="btn dropdown-toggle" data-bs-toggle="dropdown"></xBtn>',
        '  <div class="dropdown-menu">',
    ...
    it('should skip disabled element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '    <xBtn class="dropdown-item" type="xBtn" disabled>Disabled xBtn</xBtn>',
    ...
    it('should skip hidden element when using keyboard navigation', done => {
      fixtureEl.innerHTML = [
        ...
        '  <xBtn class="btn dropdown-toggle" data-bs-toggle="dropdown">Dropdown</xBtn>',
        '  <div class="dropdown-menu">',
        '    <xBtn class="dropdown-item d-none" type="xBtn">Hidden xBtn by class</xBtn>',
    ...
    it('should not open dropdown if escape key was pressed on the toggle', done => {
      ...
      const button = fixtureEl.querySelector('xBtn[data-bs-toggle="dropdown"]')
